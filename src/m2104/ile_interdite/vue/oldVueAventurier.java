...
public class oldVueAventurier {
    ...
    public void activerBoutons(Boolean activerMove, Boolean activerDry, Boolean activerDonner, Boolean activerRecuperer, Boolean activerRecevoir, Boolean activerDeplacer, Boolean activerTerminer) {
        if (Parameters.LOGS) {
            System.out.println(this.nomAventurier + " : oldVueAventurier.activerBoutons(activerMove=" + activerMove + ", activerDry=" + activerDry + ", activerDonner=" + activerDonner + ", activerRecuperer=" + activerRecuperer + ", activerRecevoir=" + activerRecevoir + ", activerTerminer=" + activerTerminer + ")");
        }
        if (activerMove != null) {
    ...
    public void activer() {
        if (Parameters.LOGS) {
            System.out.println("oldVueAventurier.activer() de " + this.nomAventurier);
        }
    ...
    public void desactiver() {
        if (Parameters.LOGS) {
            System.out.println(this.nomAventurier + " : oldVueAventurier.desactiver()");
        }
        this.labelTitre.setText(getTitle(Color.WHITE, this.couleurInactive));
        this.mainPanel.repaint();
    }
